    ...
    <>
      ...
      <main className="pt-16">
        ...
        <section className="max-w-3xl mx-auto px-3 md:px-5 py-12">
          {/* Bio Section */}
          <div className="mb-12">
            <h2 className="text-[10px] uppercase tracking-widest text-muted-foreground font-inter mb-4">
              ARTIST BIO
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 py-8 border-y border-border">
            <div className="text-center">
              ...
              <p className="text-[10px] uppercase tracking-widest text-muted-foreground mt-1">Based In</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-playfair text-foreground">45-60</p>
              <p className="text-[10px] uppercase tracking-widest text-muted-foreground mt-1">Set Length (min)</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-playfair text-foreground">18+</p>
              <p className="text-[10px] uppercase tracking-widest text-muted-foreground mt-1">Recommended</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-playfair text-foreground">English</p>
              <p className="text-[10px] uppercase tracking-widest text-muted-foreground mt-1">Language</p>
            </div>
          </div>

          {/* Downloads */}
          <div className="mb-12">
            <h2 className="text-[10px] uppercase tracking-widest text-muted-foreground font-inter mb-6">
              PRESS MATERIALS
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Button variant="outline" className="justify-start h-auto py-4 px-5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-muted-foreground">Short and long versions</p>
                </div>
              </Button>
              <Button variant="outline" className="justify-start h-auto py-4 px-5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-muted-foreground">High-res press photos</p>
                </div>
              </Button>
              <Button variant="outline" className="justify-start h-auto py-4 px-5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-muted-foreground">5-minute performance clip</p>
                </div>
              </Button>
              <Button variant="outline" className="justify-start h-auto py-4 px-5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-muted-foreground">Complete press kit</p>
                </div>
              </Button>
            </div>
          </div>
